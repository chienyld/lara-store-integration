...
@section('content')
    ...
    <splide>
        ...
        <div style="border-radius:10px;overflow:hidden">
            <img style="width:100%" src="/storage/card_image/thumb.{{$card->card_image}}">
        </div>
        </splide-slide>
            @endforeach
    </splide>
...
<br>
    ...
    @auth
    @if(! Auth::user()->active)
        <div class="well" style="background-color: #CDCDCD;color:#6e6e6e">
            <span>此帳號尚未通過審核或已被停權，大部分功能目前無法使用，相關問題請聯繫管理員</span>
        </div>  
    @endif
    @endauth 
